...
| N5 | **Developer → QA**: Task/TaskStep/work products; Claudio → Claudia with the correction loop; worktree strategy (ADR-010 B); migration 008 | `domain/` (task machine), `orchestrator/` (supervisor), `store/migrations/008`, frontend task view | inherited | 06, 09, 13 |
