...
| `GET /api/specialists` | list the same identities as reusable roles (ADR-008, N3a) | `{specialists: [{id, name, role, capabilities, allowedTools}]}` — read-only; personal sessions + direct conversation are N3b |
