...
| [adr/](./adr/README.md) | ADR-001..015 accepted | see adr/README.md |
...
| [ADR-013](./adr/ADR-013-orchestrator-decomposition.md) | Decompose the **Orchestrator** god-class into four intra-module collaborators behind a thin facade (from the architecture review C4); boundaries preserved; **amended 2026-07-24 — dedicated structure-only extraction PRs, map updated for ADR-014/015** | **accepted** (owner, 2026-07-24, amended 2026-07-24) |
